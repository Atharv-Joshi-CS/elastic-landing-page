...
const Header = (props : any) => {
    ...
    let navigatonButtons : React.ReactNode[] = Array.from(data.cta_buttons.map((button : any) => <a className={button.button_type === "PRIMARY" ? styles.primary_button : `secondary_button ${styles.secondary_btn_padding}` } href={button.cta_link.href}>{button.cta_link.title}</a>)) 
